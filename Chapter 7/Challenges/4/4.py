########## Not sure how to sort high scores this way ########################
...
def main():
    ...
    high_scores.write(ns)
    high_scores.close()

    see_scores = input("Press s if you would like to see the high scores list")
    high_scores = open("high_scores.txt", "r")
    if see_scores == "s":
        while True:
            hs = high_scores.readline()
            if hs == "":
                break
            else:
                print(hs)
